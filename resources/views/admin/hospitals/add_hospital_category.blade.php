...
@section('admin_content')
    ...
    <div class="content-header pb-1 pt-2">
        <div class="container-fluid">
            <div class="row mb-1">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark">Add Hospital Category</h4>
                    <ol class="breadcrumb float-sm-left">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"><i class="fas fa-home"></i>
                                Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('admin.blood.group.list') }}">Hospitals</a></li>
                        <li class="breadcrumb-item active">Add Hospital Category</li>
                    </ol>
                </div><!-- /.col -->
                <div class="col-sm-6">
