...
@section('admin-page-title')
    {{ translate('Add New Fire service') }}
@stop
@section('custom_css')
@stop
                ...
                <div class="offset-lg-3 mt-4 col-lg-6 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">{{ translate('Add New Fire service') }}</h3>
                            <a href="{{ route('admin.fireservice.list') }}"
                                class="btn btn-danger btn-sm float-right text-white">{{ translate('Fire services') }}</a>
                        </div>
                        <!-- /.card-header -->
