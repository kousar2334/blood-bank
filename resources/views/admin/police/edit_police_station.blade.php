...
@section('admin_content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark">Edit Police Stations</h4>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{ route('admin.fireservice.list') }}">@extends('admin.layouts.main')
                            @section('admin-page-title')
                                Admin | Edit Police Stations
                            @stop
                            @section('custom_css')
                                            ...
                                            <div class="col-sm-6">
                                                <ol class="breadcrumb float-sm-right">
                                                    <li class="breadcrumb-item"><a
                                                            ...
                                                            Dashboard</a></li>
                                                    <li class="breadcrumb-item"><a
                                                            href="{{ route('admin.police.list') }}">Police Stations</a>
                                                    </li>
                                                    <li class="breadcrumb-item active">Edit Police Stations</li>
                                                </ol>
                                            </div>
                                        </div>
                                    </div><!-- /.container-fluid -->
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body row">
                                                        <form role="form" action="{{ route('admin.police.update') }}"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        @if ($errors->has('name'))
                                                                            <small
                                                                                class="text text-danger">{{ $errors->first('name') }}</small>
                                                                        @endif
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        @if ($errors->has('phone'))
                                                                            <small
                                                                                class="text text-danger">{{ $errors->first('phone') }}</small>
                                                                        @endif
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="mobile_1"
                                                                            value="{{ $police->mobile_1 }}"
                                                                            class="form-control" placeholder="Enter ...">
                                                                        @if ($errors->has('mobile_1'))
                                                                            <small
                                                                                class="text text-danger">{{ $errors->first('mobile_1') }}</small>
                                                                        @endif
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control" name="status">
                                                                            <option
                                                                                {{ $police->status == '1' ? 'selected' : '' }}
                                                                                value="1">
                                                                                Active</option>
                                                                            <option
                                                                                {{ $police->status == '0' ? 'selected' : '' }}
                                                                                value="0">
                                                                                Inactive</option>
