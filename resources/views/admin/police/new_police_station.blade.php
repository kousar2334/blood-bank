...
@section('admin-page-title')
    {{ translate('Add New Police Station') }}
@stop
@section('custom_css')
                ...
                <div class="offset-lg-3 mt-4 col-lg-6 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">{{ translate('Add New Police Station') }}</h3>
                            <a href="{{ route('admin.police.list') }}"
                                class="btn btn-success btn-sm float-right text-white">{{ translate('Police Stations') }}</a>
                        </div>
