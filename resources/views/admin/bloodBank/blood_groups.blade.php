                    ...
                    <div class="row m-0">
                        ...
                        <div class="modal hide" id="modal-add-event">
                            ...
                            <div class="modal-footer"> <a href="#" class="btn" data-dismiss="modal">Cancel</a>
                                <button class="my-btn my-btn-md">Save</button> </div>
                        </div>
                        <!--Modal end-->
                    </div>
                </div>
