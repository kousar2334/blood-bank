					...
					<card type="secondary" header-classes="bg-white pb-5" body-classes="px-lg-5 py-lg-5"
						...
						<template>
							<div class="btn-wrapper text-center mb-5">
								<h3 class="bangla-font">অ্যাম্বুলেন্স নিবন্ধন</h3>
							</div>
						</template>
						<template>
							<form>
								<div class="row">
									<div class="col-md-12">
										...
										<div class="form-group">
											<label class="bangla-font mb-0 font-weight-bold">
												নাম (ইংরেজিতে) <span class="text-danger">*</span></label>
											<input type="text" class="form-control bangla-font" placeholder="নাম লিখুন"
												v-model="name" />
										...
										<div class="form-group">
											<label class="bangla-font mb-0 font-weight-bold">অ্যাম্বুলেন্সের বর্ণনা
												<span class="text-danger">*</span></label>
											<textarea v-model="description" class="form-control bangla-font" rows="4"
												placeholder="অ্যাম্বুলেন্সের  বর্ণনা লিখুন "></textarea>
										...
										<div class="text-center">
											<base-button type="primary" class="my-4 bangla-font"
												@click.prevent="createNewAmbulance">জমা দিন</base-button>
										</div>
									</div>
								</div>
							</form>
...
export default {
	...
	methods: {
		...
		createNewAmbulance() {
			...
			axios
				.post("/api/store-new-ambulance", form_data)
				.then((response) => {
					if (response.data.success) {
